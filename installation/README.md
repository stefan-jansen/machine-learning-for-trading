...
2. Clone the starter repo using the following command: `git clone ` and change into the new directory.
    > On windows, you may have to give Docker permissions to access your drive as outlined [here](https://rominirani.com/docker-on-windows-mounting-host-directories-d96f3f056a2c).
