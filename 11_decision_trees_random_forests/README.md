...
- How to gain insights from decision trees and visualize the rules learned from the data
...
- How to employ a Random Forest to design and evaluate a profitable trading strategy
