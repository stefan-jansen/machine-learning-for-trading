...
The notebook [backtesting_with_zipline](09_backtesting_with_zipline.ipynb) creates a strategy based on the model predictions, simulates its historical performance using [Zipline](https://stefan-jansen.github.io/zipline/, and evaluates the result using [Pyfolio](https://github.com/quantopian/pyfolio. 
