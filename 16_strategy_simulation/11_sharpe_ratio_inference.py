...
show_with_alt(
    fig,
    "Histogram of 1,000 simulated Sharpe estimates in grey with the formula's sampling "
    "distribution drawn over it as an amber curve, a dotted vertical line at zero and a dashed "
    "green line at the true Sharpe. The histogram matches the curve closely and is wide: it spans "
    "roughly -2 to +3.5 around a true value of 0.5, so a large share of the simulated track "
    "records come out negative even though every one was generated by the same profitable "
    "strategy.",
)
...
show_with_alt(
    ...
    "falls steeply, from about 40,000 days at a target near 0.2 to a few hundred at 2.5, and "
    "crosses the three-year line at roughly 1.45 and the one-year line only near 2.5.",
)
