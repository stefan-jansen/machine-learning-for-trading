# Machine Learning for Algorithmic Trading - 2nd Edition (May 2020)
...
### From Volatility Forecasts to Statistical Aribtrage: Time Series Models
...
### Bayesian ML: Dynamic Sharpe Ratios and Pairs Trading Strategies
...
### Long-short Signals with Decision Trees and Random Forests
...
### Extracting better features: Word embeddings for Earnings Calls and SEC Filings
...
### CNN: Time Series as Images and Satellite Image Classification
...
### RNN for Trading: Multivariate return series and text data
...
### Reinforcement Learning: Building a Trading Agent
