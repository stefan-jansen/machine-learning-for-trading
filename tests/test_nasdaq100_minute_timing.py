...
def test_nasdaq_next_bar_execution_matches_the_five_minute_label_window() -> None:
    ...
    assert case_config.cadence == "1_minute"
    assert spec["backtest_config"]["calendar"]["data_frequency"] == "1m"
    assert get_rebalance_step(CASE_STUDY, "fwd_ret_5m") == 4
