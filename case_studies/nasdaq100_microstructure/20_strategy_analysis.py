...
#
# `Study.at` is the read-only form: one root, no activation, and it points the path helpers at
...
study = Study.at(CASE_DIR, case_study=CASE_STUDY, entry_point="20_strategy_analysis")
