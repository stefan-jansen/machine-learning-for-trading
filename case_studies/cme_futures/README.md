...
|-------|----------|---------|-------------|--------|
| Feasibility | [`01_feasibility_analysis`](01_feasibility_analysis.ipynb) | Ch6 | Universe breadth per decision date, round-trip cost recovered per product, move-to-cost scale, carry persistence, and the declared walk-forward folds | none |
