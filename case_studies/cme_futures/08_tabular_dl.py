...
# device this population was fitted on, and the canonical tier accepts no other: a reader without
# an NVIDIA card sets `DEVICE="cpu"`, which is only allowed under a preview tier, whose workspace
# is discarded and whose rows are excluded from the catalog the backtest reads.
