...
# %% [markdown]
# # IPCA for the US Equities Panel
#
# IPCA is the cross-sectional latent-factor counterpart to the PCA baseline on
# the broad US equities universe.

# %%
"""US equities panel IPCA case-study run via the shared latent-factor library path."""
