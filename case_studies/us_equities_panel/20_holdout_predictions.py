...
if retire.not_out_of_sample:
    raise RuntimeError(
        ...
        "which `20_strategy_synthesis/holdout.py::generate_holdout` produces - and the registry "
        "cannot tell those apart. This notebook has no way past that: establish which it is and "
