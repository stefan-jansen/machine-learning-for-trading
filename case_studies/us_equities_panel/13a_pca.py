...
# %% [markdown]
# # PCA for the US Equities Panel
#
# The broad US equities panel is the cleanest place to benchmark return-panel
# PCA against direct cross-sectional predictors.

# %%
"""US equities panel PCA case-study run via the shared latent-factor library path."""
