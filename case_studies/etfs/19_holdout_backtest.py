...
# of the validation span reach into the holdout window, and calibrating on them would size
...
print(f"Prices: {len(prices):,} rows, {prices['symbol'].n_unique():,} funds")
